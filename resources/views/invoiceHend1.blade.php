                  ...
                  <li><a><i class="fa fa-table"></i> MRP <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a>Inventory<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu"><a href="inventoryRaw.html">Raw Material</a>
                            </li>
                            <li><a href="inventoryProduct.html">Product</a>
                            </li>
                          </ul>
                        </li>
						<li><a>Order<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu"><a href="orderRaw.html">Raw Material</a>
                            </li>
                            <li><a href="orderProduct.html">Product</a>
                            </li>
                          </ul>
                        </li>
                      <li><a href="bom.html">Bill of Materials</a></li>
					  <li><a href="#">Master Production Schedule</a></li>
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col">
                          From
                          <address>
                                          <strong>HEN-D Sdn Bhd</strong>
                                          <br>795 Freedom Ave, Suite 600
                                          <br>Johor, Malaysia
                                          <br>Phone: +607-7878112
                                          <br>Email: hend990@hend.com
                                      </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                          ...
                          <address>
                                          ...
                                          <br>795 Freedom Ave, Suite 82300
                                          <br>Pontian, Malaysia
                                          <br>Phone: +60192227736
                                          <br>Email: Ahmad88@gmail.com
                                      </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
