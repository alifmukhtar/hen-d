                ...
                <div class="x_panel">
                  <div class="x_title">
                    <ul class="nav navbar-right panel_toolbox">
                      <li><button type="button" class="btn btn-def" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus"></i> Raw material</button>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      The list of details of raw materials available in the warehouse inventory.
                    </p>
